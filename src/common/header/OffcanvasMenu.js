                        ...
                        <div className="contact-info-wrap">
                            <div className="contact-inner">
                                <address className="address">
                                    ...
                                    <p>C/O-S.K.Mishra, C.M.R.S. Gate, Bartand, Dhanbad, <br /> Dhanbad, Jharkhand, India (826001)</p>
                                </address>
                                <address className="address">
                                    <span className="title">We're Available 24/7.</span>
                                    <a href="tel:8884562790" className="tel"><FaPhone /> +91 6289409441</a>
                                    <a href="mailto:support@thetutorlancer.com" className="tel"><FaFax /> support@thetutorlancer.com</a>
                                </address>
                            </div>
                            <div className="contact-inner">
