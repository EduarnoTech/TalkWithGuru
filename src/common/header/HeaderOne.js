                ...
                <div className={`axil-mainmenu ${sticky ? "axil-sticky" : ""}`}>
                    <div className="container">
                        <div className="header-navbar">
                            <div style={{width:"120px",height:"60px",fill:"none"}} className="header-logo" >
                                <Logo limage="/images/studybuddyLogo-PhotoRoom.png"
                                dimage="/images/studybuddyLogo-PhotoRoom.png"
                                simage="/images/studybuddyLogo-PhotoRoom.png"
                                />
                            </div>
